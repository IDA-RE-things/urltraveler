...
void C360ChromePlugIn::SortByDepth(PFAVORITELINEDATA pData, int32 nDataNum)
{
...
void C360ChromePlugIn::SortNode(PFAVORITELINEDATA pData, int32 nDataNum, PFAVORITELINEDATA& pSortData, int32 nParentId)
{
	static int k = 0;
...
BOOL C360ChromePlugIn::ExportFolder(Json::Value& folder_obj, int32 nPid, PFAVORITELINEDATA pData, int32& nDataNum)
{
...
BOOL C360ChromePlugIn::ExportUrl(Json::Value& url_obj, int32 nPid, PFAVORITELINEDATA pData, int32& nDataNum)
{
...
BOOL C360ChromePlugIn::MakeFolderNode(FAVORITELINEDATA stData, Json::Value& folder_obj, uint32& nIndex)
{
...
BOOL C360ChromePlugIn::MakeUrlNode(FAVORITELINEDATA stData, Json::Value& url_obj, uint32& nIndex)
{
	wchar_t szFormat[] = L" {\
						  \"date_added\": \"%s\",\
						  \"id\": \"%u\",\
...
BOOL C360ChromePlugIn::TraverseNode(PFAVORITELINEDATA pData, int32 nDepth)
{
	if (nDepth >= 0)
	{
