...
void CPropertiesWnd::InitPropList()
{
	...
	pValueList->AddSubItem(pProp);
	pProp=new CMFCPropertyGridProperty(_T("MaxHeight"),(_variant_t)(LONG)0,_T("窗口的最大跟踪高度"));
	pValueList->AddSubItem(pProp);
	pPropUI->AddSubItem(pValueList);
	...
	pProp=new CMFCPropertyGridProperty(_T("Group"),(_variant_t)_T("GroupName"),_T("指示是否参与组合"),tagGroup);//group
	pPropUI->AddSubItem(pProp);
	...
	pProp=new CMFCPropertyGridProperty(_T("ItemShowHtml"),(_variant_t)false,_T("是否显示HTML"),tagListItemShowHtml);//columns
	pPropUI->AddSubItem(pProp);

	pProp=new CMFCPropertyGridProperty(_T("ItemAlign"),_T("Center"),_T("Item对齐方式"),tagListItemAlign);//columns
	pProp->AddOption(_T("Center"));
	pProp->AddOption(_T("Left"));
	pProp->AddOption(_T("Right"));
	pProp->AddOption(_T("Top"));
	...
	pProp=new CMFCPropertyGridProperty(_T("Menu"),(_variant_t)false,_T("是否显示菜单"),tagListMenu);//columns
	pPropUI->AddSubItem(pProp);
	m_wndPropList.AddProperty(pPropUI);
