...
* 文件名称：crypt.h
* 内容摘要：sqlite加密头功能文件
*			此文件主要用来防止pager.c中的struct Pager结构的定义以使代码可以编译通过
* 其它说明：
* 当前版本：
* 作    者：温辉敏
* 完成日期：2008-7-10
...
*    修改内容：
**********************************************************/
#if !defined(AFX_CRYPT_H__DD58A78D_C125_410F_B4C8_F0067B797121__INCLUDED_)
#define AFX_CRYPT_H__DD58A78D_C125_410F_B4C8_F0067B797121__INCLUDED_
...
//////////////////////////////////////////////////////////////////////////
///加的区分采用Windows 加密还是BlowFish加密的宏定义
#define BLOW_FISH_ENCRYPT 

#ifndef  BLOW_FISH_ENCRYPT
#define WINDOWS_ENCRYPT
#endif

#ifdef BLOW_FISH_ENCRYPT
#include "../BlowFishCrypt/BlowFishCWrapper.h"
#endif
...
// 补充上 [8/26/2008 温辉敏]
// #define DATA_TO_PGHDR(pData)    (pData)
...
#endif // !defined(AFX_CRYPT_H__DD58A78D_C125_410F_B4C8_F0067B797121__INCLUDED_)
