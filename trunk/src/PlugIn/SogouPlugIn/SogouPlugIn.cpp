...
CSogouPlugIn::CSogouPlugIn()
{
	...
	if (decode(StringHelper::UnicodeToANSI(GetFavoriteDataPath()), strDecodeContent) == 0)
	{
		...
		m_SqliteDatabase.execDML("insert into favorTable(id,pid,folder,title,url,sequenceNo,addtime,lastmodify,hashid,category,reserved) values(2,0,0,'百度','http://www.baidu.com',2,'2011-05-09 10:23:10','2011-05-09 10:23:10',112358,0,0)");
