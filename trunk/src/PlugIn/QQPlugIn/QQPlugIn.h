...
class QQPlugIn : public PlugInImp
{
public:
	QQPlugIn();
	~QQPlugIn();
...
private:
	...
	BOOL MakeFolderNode(FAVORITELINEDATA* pstData, Json::Value& folder_obj, uint32& nIndex);
	BOOL MakeUrlNode(FAVORITELINEDATA* pstData, Json::Value& url_obj, uint32& nIndex);
