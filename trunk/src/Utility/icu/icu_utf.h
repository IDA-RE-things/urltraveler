...
#ifdef ICU_EXPORTS
#define ICU_API __declspec(dllexport)
#else
#define ICU_API __declspec(dllimport)
#endif
 ...
 * @internal
 */
ICU_API UChar32 utf8_nextCharSafeBody(const uint8 *s, int32 *pi, int32 length, UChar32 c, UBool strict);
...
#define CBU16_GET_SUPPLEMENTARY(lead, trail) \
    (((UChar32)(lead)<<10UL)+(UChar32)(trail)-CBU16_SURROGATE_OFFSET)
