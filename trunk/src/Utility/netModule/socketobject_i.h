...
namespace NetModule
{
	...
	public:
		...
		/**
		* @brief 当模式为 SOCKETOPT_CACHEPACKET 时，调本函数，可以设置Cache Packet包大小
		*
		* @param byPacketSize [in] : Packet Size, 单位：KB
		*
		* @return
		*
		* <p>
		...
		*/
		...
		/**
		 * @brief  设置Socket Option.可以为下面选项的组合
		 *			  SOCKETOPT_CACHEPACKET : Cache Packet 模式
		 *			  SOCKETOPT_DELAYRECEIVE : 延迟读模式
		 * 
		 * @param  pSocketOption [in] : Socket模式
		 * @see PSOCKETOPTION
		 */
