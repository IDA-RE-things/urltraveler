...
int Registry::GetDataSize(String strValueName)
{
...
String Registry::ReadString(String strName, String strDefault)
{
	DWORD dwType = REG_SZ;
	DWORD dwSize = 255;
	BOOL bSuccess = TRUE;
...
DWORD Registry::ReadDword(String strName, DWORD dwDefault)
{
...
int Registry::ReadInt(String strName, int nDefault)
{
	DWORD dwType = REG_BINARY;
	int n;
...
BOOL Registry::ReadBool(String strName, BOOL bDefault)
{
	DWORD dwType = REG_BINARY;
	BOOL b;
...
COLORREF Registry::ReadColor(String strName, COLORREF rgbDefault)
{
	DWORD dwType = REG_BINARY;
	COLORREF rgb;
...
BOOL Registry::WriteBool(String strName, BOOL bValue)
{
	ASSERT(m_strCurrentPath.GetLength() > 0);
	BOOL bSuccess = TRUE;
	HKEY hKey;
...
BOOL Registry::WriteString(String strName, String strValue)
{
	ASSERT(m_strCurrentPath.GetLength() > 0);
	BOOL bSuccess = TRUE;
	HKEY hKey;
...
BOOL Registry::WriteFloat(String strName, double fValue)
{
	ASSERT(m_strCurrentPath.GetLength() > 0);
	BOOL bSuccess = TRUE;
	HKEY hKey;
...
BOOL Registry::WriteInt(String strName, int nValue)
{
	ASSERT(m_strCurrentPath.GetLength() > 0);
	BOOL bSuccess = TRUE;
	HKEY hKey;
...
BOOL Registry::WriteDword(String strName, DWORD dwValue)
{
	ASSERT(m_strCurrentPath.GetLength() > 0);
	BOOL bSuccess = TRUE;
	HKEY hKey;
...
BOOL Registry::WriteColor(String strName, COLORREF rgbValue)
{
	ASSERT(m_strCurrentPath.GetLength() > 0);
	BOOL bSuccess = TRUE;
	HKEY hKey;
