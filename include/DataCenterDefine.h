...
namespace datacenter
{
	...
	enum E_DataCenterServiceValue
	{
		...
		SERVICE_VALUE_DATACENTER_CLEAR_DATA,				// 清除数据
...
#define MAX_COOKIE_HOST_LEN	128
	...
	struct DataCenter_ClearDataService : public Service
	{
		DataCenter_ClearDataService()
		{
			serviceId =  SERVICE_VALUE_DATACENTER_CLEAR_DATA;
		}
	};
};