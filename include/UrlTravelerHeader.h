...
enum EventValueRanges
{
	...
	//数据中心模块
	EVENT_VALUE_DATACENTER_BEGIN=EVENT_VALUE_BEGIN(MODULE_ID_DATACENTER),
	EVENT_VALUE_DATACENTER_END=EVENT_VALUE_END(MODULE_ID_DATACENTER),

	//登录模块
	EVENT_VALUE_LOGIN_BEGIN=EVENT_VALUE_BEGIN(MODULE_ID_LOGIN),
	EVENT_VALUE_LOGIN_END=EVENT_VALUE_END(MODULE_ID_LOGIN),

	//插件管理模块
	EVENT_VALUE_PLUGIN_BEGIN=EVENT_VALUE_BEGIN(MODULE_ID_PLUGIN),
	EVENT_VALUE_PLUGIN_END=EVENT_VALUE_END(MODULE_ID_PLUGIN),

	//数据库模块
	EVENT_VALUE_DATABASE_BEGIN=EVENT_VALUE_BEGIN(MODULE_ID_DATABASE),
	EVENT_VALUE_DATABASE_END=EVENT_VALUE_END(MODULE_ID_DATABASE),
};
...
enum MessageValueRanges
{
	...
	//数据中心管理模块
	MESSAGE_VALUE_DATACENTER_BEGIN=MESSAGE_VALUE_BEGIN(MODULE_ID_DATACENTER),
	MESSAGE_VALUE_DATACENTER_END=MESSAGE_VALUE_END(MODULE_ID_DATACENTER),

	//登录管理模块
	MESSAGE_VALUE_LOGIN_BEGIN=MESSAGE_VALUE_BEGIN(MODULE_ID_LOGIN),
	MESSAGE_VALUE_LOGIN_END=MESSAGE_VALUE_END(MODULE_ID_LOGIN),

	//插件管理模块
	MESSAGE_VALUE_PLUGIN_BEGIN=MESSAGE_VALUE_BEGIN(MODULE_ID_PLUGIN),
	MESSAGE_VALUE_PLUGIN_END=MESSAGE_VALUE_END(MODULE_ID_PLUGIN),

	//数据库管理模块
	MESSAGE_VALUE_DATABASE_BEGIN=MESSAGE_VALUE_BEGIN(MODULE_ID_DATABASE),
	MESSAGE_VALUE_DATABASE_END=MESSAGE_VALUE_END(MODULE_ID_DATABASE),
...
enum ServiceValueRanges
{
	...
	//数据中心模块
	SERVICE_VALUE_DATACENTER_BEGIN=SERVICE_VALUE_BEGIN(MODULE_ID_DATACENTER),
	SERVICE_VALUE_DATACENTER_END=SERVICE_VALUE_END(MODULE_ID_DATACENTER),

	//登录模块
	SERVICE_VALUE_LOGIN_BEGIN=SERVICE_VALUE_BEGIN(MODULE_ID_LOGIN),
	SERVICE_VALUE_LOGIN_END=SERVICE_VALUE_END(MODULE_ID_LOGIN),

	//插件管理模块
	SERVICE_VALUE_PLUGIN_BEGIN=SERVICE_VALUE_BEGIN(MODULE_ID_PLUGIN),
	SERVICE_VALUE_PLUGIN_END=SERVICE_VALUE_END(MODULE_ID_PLUGIN),

	//数据库管理模块
	SERVICE_VALUE_DATABASE_BEGIN=SERVICE_VALUE_BEGIN(MODULE_ID_DATABASE),
	SERVICE_VALUE_DATABASE_END=SERVICE_VALUE_END(MODULE_ID_DATABASE),
};
